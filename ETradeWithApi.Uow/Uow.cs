...
namespace ETradeWithApi.Uow
{
    public class Uow : IUow
    {
        ...
        public Uow(TradeContext db, IBasketDetailRep basketDetailRep, IBasketMasterRep basketMasterRep, ICategoriesRep categoriesRep, ICityRep cityRep, ICountyRep countyRep, IProductsRep productsRep, IUnitRep unitRep, IUsersRep usersRep, IVatRep vatRep)
        {
            _db = db;
